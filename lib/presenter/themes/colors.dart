...
abstract class AppColors {
  ...
  // Website Main colors
  static const Color darkGreen = Color(0xFF2B463C);
  static const Color primaryGreen = Color(0x00688f4e);
  static const Color pastelGreen = Color(0xFFB1D182);
  static const Color offWhite = Color(0xFFF4F1E9);
  static const Color darkBackgound = Color.fromARGB(255, 30, 30, 30);
  static const Color buttonBgColor = Color.fromARGB(255, 176, 209, 130);
  static const Color buttonBgColorText = Color.fromARGB(33, 29, 29, 1);
}
